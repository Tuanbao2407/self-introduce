...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        marshall:
          "0 4px 6px -1px rgba(203, 161, 53, 0.1), 0 2px 4px -1px rgba(203, 161, 53, 0.06)",
        "marshall-lg":
          "0 10px 15px -3px rgba(203, 161, 53, 0.1), 0 4px 6px -2px rgba(203, 161, 53, 0.05)",
      },
      backgroundImage: {
      ...
      animation: {
        "marshall-pulse":
          "marshall-pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite",
